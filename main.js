...
var planets = [
    ...
    {
        name:"NOT PLUTO",
        url: "http://mediacdn.snorgcontent.com/media/catalog/product/i/t/itsokaypluto_fullpic_artwork.jpg"
    }
];


button.addEventListener("mouseenter", printPlanets);
// button.addEventListener("mouseleave", clearOutput)
clear.addEventListener("click", clearOutput);

// planetBoxes.addEventListener("click", showMeWhatYouGot);
...
function printPlanets() {
  ...
  for (var i = 0; i < planets.length; i++) {
    ...
    newPlanet += `<div class="planetName hidden"> ${planets[i].name} </div>`; //ES6 String theory. Look it up!
...
function showMeWhatYouGot(event){
...
document.body.addEventListener("click", showMeWhatYouGot);
